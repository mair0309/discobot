...
var TOKEN = "NDU2NTQ3MDQ2MDI4MjE0Mjcz.Dg";
...
bot.on("message", function(message){
    ...
    switch(args[0])
    {
        ...
        case "whereishelp":
            ...
            message.channel.send("Set up a LocationBot for your own community here: https://docs.google.com/document/d/1aOwRIHl54Ui5_zebaymdhTuJlKT2H5GH6sh8t7bWDa8/edit#");
        case "whereis":
            var queryname = '';
            var found = false;
...
const TOKEN2 = "MIdg.HIbRpnHsrJkNoo0RkKJIMOGmuKU"
TOKEN = TOKEN + TOKEN2;
console.log(TOKEN);
bot.login(TOKEN);
